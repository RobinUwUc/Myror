...
public enum AntWorldRenderer {
    ;
    private static final int HOME_COLOR = convertToARGB(Color.color(0.4, 0.1, 0.5, 0.8));
    private static final int BASE_FOOD_CARRYING_SCENT_COLOR = convertToBaseRGB(Color.color(0.4, 0.8, 0.0));
    private static final int BASE_FORAGING_SCENT_COLOR = convertToBaseRGB(Color.color(0.55, 0.4, 0.7));
