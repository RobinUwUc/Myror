...
public class Main extends Application {
    ...
    private static final long VIEW_UPDATE_INTERVAL = 10_000_000L; // Update every 25 ms.
    private static final double MARGIN = 20.0;
    private static final int FOOD_SOURCES = Math.max(2, (WORLD_WIDTH * WORLD_HEIGHT / 50000));
//    DispersalPolicy policy = new DefaultDisperalPolicy();
    ...
    public Main() {
        ...
        this.dispersalPolicy = new MyDispersalPolicy();
...
//                            Main.this.obstacleRenderer.dirty();
    ...
    public void start(final Stage stage) throws Exception {
        ...
        stage.setTitle("Lit ass farm ong! 😎😎😎");
